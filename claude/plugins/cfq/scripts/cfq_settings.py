...
SCHEMA = {
    ...
    "htmlReport": {"type": "bool", "default": True, "scope": ["global", "repo"], "env": None, "description": "Render the HTML report at batch end; set false to render only on /rfq request."},
    ...
    "reportDir": {"type": "string", "default": "", "pattern": "^($|/.*)$", "scope": ["global", "repo"], "env": "CFQ_REPORT_DIR", "description": "Absolute path of the directory HTML reports are collected in; empty renders into <repo>/.claude/cfq/reports/ instead."},
