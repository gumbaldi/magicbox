...
Every batch gets `<batch-dir>/.batch-context.md`, written once during pfq's **Park**, alongside the phase
...
## Non-Goals
<only if something was explicitly ruled out during the interview, or dropped at
**Self-Critique of the Phase Cut** — either way, state the reason>
```
